...
].map(movie => ({ ...movie, posterUrl:"", networkChannel:"Star Launcher" }));
window.HERMIT_CATALOG = window.STAR_LAUNCHER_CATALOG;

window.INFINITY_CHANNEL = {
  id:"STAR-LAUNCHER",
  sourcePolicy:"Checked-in retro action/comedy/adventure catalog; no R-rated or age-restricted entries.",
...
window.HERMIT_COMMERCIALS = window.STAR_LAUNCHER_COMMERCIALS;
