...
(function () {
  ...
  window.STAR_LAUNCHER_CATALOG = rows.map(function (row, index) {
    return {
  ...
  window.STAR_LAUNCHER_COMMERCIALS = [
    ...
    {id:"AD-002",title:"Tonight on Star Launcher",durationSeconds:60,videoId:"",cleared:true},
