(function (root) {
  ...
  function createDaySchedule(nowMs, catalog) {
    ...
    if (!eligible.length) throw new Error("Star Launcher has no playable movies configured.");
  ...
  root.StarLauncherEngine = { TIME_ZONE, BLOCK_SECONDS, stationParts, zonedToUtc, dateKey, createDaySchedule, createSegments, resolve };
})(window);
